...
class DepositsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create deposit" do
    assert_difference('Deposit.count') do
      post deposits_url, params: { deposit: { deposit_amount: @deposit.deposit_amount, goal_id: @deposit.goal_id } }
    end
  ...
  test "should update deposit" do
    patch deposit_url(@deposit), params: { deposit: { deposit_amount: @deposit.deposit_amount, goal_id: @deposit.goal_id } }
